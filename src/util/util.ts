...
/**
 * registers the routes with the `serviceName`
 *
 * @param {hapi.ServerRoute[]} routes - routes to register
 * @return {HSServiceApp}
 */
export const registerServiceRoutes = (server: Hapi.Server, routes: Hapi.ServerRoute[]): void => {
    ...
    await server.register([
        ...
        },
        {
            ...
            options: {
                ...
                info: {
                    title: `Adventure Buddy Service API Documentation`,
                },
                securityDefinitions: {
                    jwt: {
                        type: "apiKey",
